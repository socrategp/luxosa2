...
// SVG ViewBox: 700 x 700 — center at 350,350
const CX = 350;
const CY = 350;
const RING_R = 200;   // main ring radius
const LABEL_R = 265;  // radius at which labels are placed (outside the ring)
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16" ref={ref}>
        ...
        <div className="text-center max-w-2xl mx-auto mb-24 md:mb-32">
          ...
          <motion.h2
            ...
            className="font-serif text-[34px] md:text-[46px] lg:text-[56px] font-light leading-[1.08] text-charcoal"
          >
            I valori che definiscono<br />la nostra identità.
          </motion.h2>
        </div>
