  ...
  return (
    <section className="py-28 md:py-36 bg-ivory">
      <div className="max-w-[1000px] mx-auto px-6 md:px-10 lg:px-16 text-center" ref={ref}>
        ...
        <motion.p initial={{ opacity: 0, y: 15 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: 0.3 }} className="mt-6 text-[15px] md:text-[16px] leading-[1.8] text-anthracite/70 font-light max-w-2xl mx-auto">
  ...
  return (
    <section className="py-24 md:py-32 bg-ivory-warm">
      <div className="max-w-[900px] mx-auto px-6 md:px-10 lg:px-16 text-center" ref={ref}>
        ...
        <motion.h2 initial={{ opacity: 0, y: 25 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8, delay: 0.15 }} className="font-serif text-[30px] md:text-[38px] lg:text-[44px] font-light leading-[1.1] text-charcoal">Viva l'esperienza Luxosa.</motion.h2>
        <motion.p initial={{ opacity: 0, y: 15 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: 0.3 }} className="mt-6 text-[15px] md:text-[16px] leading-[1.8] text-anthracite/65 font-light max-w-lg mx-auto">Si affidi a un metodo di cura pensato per Lei. Prenoti la sua prima consulenza.</motion.p>
