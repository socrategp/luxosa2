  ...
  return (
    <section className="py-24 md:py-32 lg:py-40 bg-ivory-warm">
      <div className="max-w-[900px] mx-auto px-6 md:px-10 lg:px-16 text-center" ref={ref}>
        ...
        <motion.h2 initial={{ opacity: 0, y: 25 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 1.2, ease: [0.25, 0.1, 0, 1], delay: 0.15 }} className="font-serif text-[30px] md:text-[38px] lg:text-[44px] font-light leading-[1.1] text-charcoal">Inizi il suo percorso<br />con una consulenza.</motion.h2>
        <motion.p initial={{ opacity: 0, y: 15 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 1, ease: [0.25, 0.1, 0, 1], delay: 0.3 }} className="mt-6 text-[15px] md:text-[16px] leading-[1.8] text-anthracite/65 font-light max-w-lg mx-auto">Insieme definiremo il percorso più adatto alle sue esigenze, ai suoi obiettivi e alla sua unicità.</motion.p>
