...
export default function IPercorsiPage() {
  return (
    <>
      <PageHero label="I Percorsi" title="Percorsi di cura,\nnon semplici servizi." subtitle="Ogni area è pensata per rispondere a un'esigenza specifica, con la profondità e l'attenzione che ogni persona merita." image="/images/hair-back-new.jpg" />
      <PercorsiIntro />
      <Percorsi />
      <Signature />
      <PercorsiCTA />
